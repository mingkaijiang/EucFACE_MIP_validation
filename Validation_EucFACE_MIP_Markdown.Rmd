...
modDF$Transpiration <- modDF$Transpiration * 100
modDF$ET <- modDF$ET * 100
modDF$ES <- modDF$ES * 100
modDF$EC <- modDF$EC * 100
modDF$RO <- modDF$RO * 100
modDF$DRAIN <- modDF$DRAIN * 100
