...
\
GPP should in theory equals to individual production fluxes and respiratory flux. Here production fluxes include: CGL, CGFR, CGCR, CGW and CREPR, and the respiratory flux is RAU.
...
\
Similarly, NPP should equal to all growth fluxes, that is, the sum of CGL, CGFR, CGCR, CGW and CREPR.
...
p1<-xyplot(I(CGW+CGL+CGFR+CGCR+CREPR)~NPP,annDF,
           #main='I(CGW+CGL+CGFR+CGCR+CREPR)~NPP',
           auto.key=T,
           scales=list(relation='free'),
           panel=function(...){
             panel.xyplot(...)
...
\
This mass balance equation checks the net of total influx litter and heterotrophic respiration. In theory, the net difference of these two flues should equal to the change in soil + litter pool. The full equation is: 

<center> CLITIN+CWLIN+CFRLIN+CCRLIN+CREPR-RHET = $\Delta$CSOIL+$\Delta$CCLITB+$\Delta$CFLIT </center>
...
p1<-xyplot(I(CLITIN+CWLIN+CFRLIN+CCRLIN+CREPR-RHET)~I(deltaCSOIL+deltaCCLITB+deltaCFLIT),annDF,
           #main='I(CLITIN+CWLIN+CFRLIN+CCRLIN+CREPR-RHET)~I(deltaCSOIL+deltaCCLITB+deltaCFLIT)',
           auto.key=T,
           scales=list(relation='free'),
           panel=function(...){
             panel.xyplot(...)
...
<center> 
PDEP+PWEA+PLITIN+PWLIN+PCRLIN+PFRLIN-PUP-PLEACH = $\Delta$PSOIL+$\Delta$FLIT+$\Delta$PCLITB
</center> 
