read_and_process_EucFACE_C_budget_output_ignore_understorey <- function() {
    ...
    outDF$CL[outDF$Group=="mean"&outDF$Trt=="diff"] <- poolDF$diff[poolDF$term=="Overstorey leaf"]
    ...
    outDF$CW[outDF$Group=="mean"&outDF$Trt=="diff"] <- poolDF$diff[poolDF$term=="Overstorey wood"]
    ...
    #                                                           nppDF$aCO2_sd[nppDF$term=="Other NPP"]^2)/6)
    #
    ...
    #                                                           nppDF$eCO2_sd[nppDF$term=="Other NPP"]^2)/6)
    #
    #
