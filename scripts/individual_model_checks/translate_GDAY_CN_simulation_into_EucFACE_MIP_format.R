translate_GDAY_CN_simulation_into_EucFACE_MIP_format <- function(met.path,
                                                                 sim.path,
                                                                 out.path) {
    ...
    out.names <- c("EUC_GDAYN_OBS_VAR_AMB_NOP_D",
                   "EUC_GDAYN_OBS_VAR_ELE_NOP_D",
                   "EUC_GDAYN_OBS_FIX_AMB_NOP_D",
                   "EUC_GDAYN_OBS_FIX_ELE_NOP_D",
                   "EUC_GDAYN_PRD_VAR_AMB_NOP_D",
                   "EUC_GDAYN_PRD_VAR_AMB_MDP_D",
                   "EUC_GDAYN_PRD_VAR_AMB_HIP_D",
                   "EUC_GDAYN_PRD_VAR_ELE_NOP_D",
                   "EUC_GDAYN_PRD_VAR_ELE_MDP_D",
                   "EUC_GDAYN_PRD_VAR_ELE_HIP_D",
                   "EUC_GDAYN_PRD_FIX_AMB_NOP_D",
                   "EUC_GDAYN_PRD_FIX_AMB_MDP_D",
                   "EUC_GDAYN_PRD_FIX_AMB_HIP_D",
                   "EUC_GDAYN_PRD_FIX_ELE_NOP_D",
                   "EUC_GDAYN_PRD_FIX_ELE_MDP_D",
                   "EUC_GDAYN_PRD_FIX_ELE_HIP_D")
    ...
    for (i in 1:16) {
       ...
       # myDF$bramchretransp <- myDF$branchretransp * tonnes_per_ha_to_g_m2
        ...
        ### include all P variables to easy future comparisons
        outDF$PL <- NA
        outDF$PW <- NA
        outDF$PCR <- NA
        outDF$PFR <- NA
        ...
        write.csv(outDF, paste0(out.path, "/GDAYN/", sceDF$out.names[i], ".csv"),
                  row.names=F)
    }
