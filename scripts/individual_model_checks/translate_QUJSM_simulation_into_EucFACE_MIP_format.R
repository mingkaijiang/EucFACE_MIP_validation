translate_QUJSM_simulation_into_EucFACE_MIP_format <- function(source.dir) {
    ...
    file.names <- c("EUC_QUJSM_OBS_VAR_AMB_NOP_D",
                    "EUC_QUJSM_OBS_VAR_ELE_NOP_D",
                    "EUC_QUJSM_OBS_FIX_AMB_NOP_D",
                    "EUC_QUJSM_OBS_FIX_ELE_NOP_D",
                    "EUC_QUJSM_PRD_VAR_AMB_NOP_D",
                    "EUC_QUJSM_PRD_VAR_AMB_MDP_D",
                    "EUC_QUJSM_PRD_VAR_AMB_HIP_D",
                    "EUC_QUJSM_PRD_VAR_ELE_NOP_D",
                    "EUC_QUJSM_PRD_VAR_ELE_MDP_D",
                    "EUC_QUJSM_PRD_VAR_ELE_HIP_D",
                    "EUC_QUJSM_PRD_FIX_AMB_NOP_D",
                    "EUC_QUJSM_PRD_FIX_AMB_MDP_D",
                    "EUC_QUJSM_PRD_FIX_AMB_HIP_D",
                    "EUC_QUJSM_PRD_FIX_ELE_NOP_D",
                    "EUC_QUJSM_PRD_FIX_ELE_MDP_D",
                    "EUC_QUJSM_PRD_FIX_ELE_HIP_D")
